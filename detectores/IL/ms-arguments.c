...
void show_mshelp(){
    ...
    printf("FORMAT: ms-inspectorlog -l logFile [-t <list|elist|apache|wellness|uri|telist>] -r modsecurity_conf_file  [-o <clean log output>] [-e (extended_alerts)] [-w (encoding warnings)] [-c (response code filtering)] [-b (labeled uris)] [-d <detailed log output>\n");
