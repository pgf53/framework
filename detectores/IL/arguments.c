...
void show_help(){
    ...
    printf("FORMAT: inspectorlog -l logFile [-t <list|elist|apache|wellness|uri|telist>] [-r ruleDir(snort)] [-m rulefile (nemeside)] [-o <clean log output>] [-n (nocase)] [-e (extended_alerts)] [-w (encoding warnings)] [-c (response code filtering)] [-b (labeled uris)]\n");
